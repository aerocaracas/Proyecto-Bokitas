...
class Medica(models.Model):
    ...
    diagnostico1 = models.CharField(max_length=50, blank=True,null=False)
    diagnostico2 = models.CharField(max_length=50, blank=True,null=False)
    diagnostico3 = models.CharField(max_length=50, blank=True,null=False)
    ...
    anemico = models.CharField(max_length=50, blank=True,null=False)
