...
class Medica(models.Model):
    ...
    diagnostico1 = models.CharField(max_length=50, blank=True,null=False, choices=DIAGNOSTICO1)
    diagnostico2 = models.CharField(max_length=50, blank=True,null=False, choices=DIAGNOSTICO2)
    diagnostico3 = models.CharField(max_length=50, blank=True,null=False, choices=DIAGNOSTICO3)
    ...
    anemico = models.CharField(max_length=50, blank=True,null=False, choices=ANEMICO)
