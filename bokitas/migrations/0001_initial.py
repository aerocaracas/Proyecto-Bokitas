    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estatus', models.BooleanField(choices=[('ACTIVO', 'ACTIVO'), ('PASIVO', 'PASIVO')], default=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL)),
                ('proyecto', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='bokitas.centro')),
            ],
            options={
                'ordering': ('-cedula',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cedula_bef', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='bokitas.beneficiario')),
                ('cedula', models.ForeignKey(blank=True, on_delete=django.db.models.deletion.CASCADE, to='bokitas.familiares')),
            ],
        ),
        migrations.CreateModel(
            name='Medica',
