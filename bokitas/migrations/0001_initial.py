    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('embarazada', models.CharField(choices=[('1', 'SI'), ('0', 'NO')], default=0, max_length=10)),
                ('lactando', models.CharField(choices=[('1', 'SI'), ('0', 'NO')], default=0, max_length=10)),
                ...
                ('tipo_usuario', models.CharField(choices=[('MEN', 'MENOR'), ('BEF', 'BENEFICIARIO'), ('EMB', 'EMBARAZADA'), ('LAC', 'LACTANTE')], default='BEF', max_length=3)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sano', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('traumatismo', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('alergia', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cefalea', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('hiperactividad', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('infeccion', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('faringoamigdalitis', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('sinusitis', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('parasitosis', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('diarreas', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('dermatitis', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('otitis', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('caries', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('abcesos', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('otros', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('otros_varios', models.TextField(blank=True, max_length=200)),
                ('desp_menor', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('desp_familia', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')], default=False)),
                ('folico', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cantidad_folico', models.PositiveIntegerField()),
                ('hierro', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cantidad_hierro', models.PositiveIntegerField()),
                ('minerales', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cantidad_minerales', models.PositiveIntegerField()),
                ('vitamina', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cantidad_vitamina', models.PositiveIntegerField()),
                ('leche', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
                ('cantidad_leche', models.PositiveIntegerField()),
                ('antiviotico', models.BooleanField(blank=True, choices=[('1', 'SI'), ('0', 'NO')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('riesgo', models.BooleanField(choices=[('1', 'SI'), ('0', 'NO')], default=False)),
