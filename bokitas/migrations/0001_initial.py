# Generated by Django 5.0.3 on 2024-09-25 19:05
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('cedula', models.PositiveIntegerField(default=0, unique=True)),
                ...
                ('estatus', models.CharField(choices=[('ACTIVO', 'ACTIVO'), ('ALTA', 'ALTA'), ('EGRESO', 'EGRESO'), ('DESINCORPORADO', 'DESINCORPORADO'), ('CERRADO', 'CERRADO')], default='ACTIVO', max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('estatus', models.CharField(choices=[('ACTIVO', 'ACTIVO'), ('ALTA', 'ALTA'), ('EGRESO', 'EGRESO'), ('DESINCORPORADO', 'DESINCORPORADO'), ('CERRADO', 'CERRADO')], max_length=30)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('observacion', models.TextField(blank=True, max_length=200)),
                ('estatus', models.CharField(choices=[('ACTIVO', 'ACTIVO'), ('ALTA', 'ALTA'), ('EGRESO', 'EGRESO'), ('DESINCORPORADO', 'DESINCORPORADO'), ('CERRADO', 'CERRADO')], default=True, max_length=30)),
                ('peso_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('talla_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('imc_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('cbi_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('ptr_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('pse_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('cc_inicial', models.DecimalField(decimal_places=2, default=0.0, max_digits=5)),
                ('diagnostico_inicial', models.CharField(blank=True, max_length=50)),
                ('diagnostico_talla_inicial', models.CharField(blank=True, max_length=50)),
                ...
                ('diagnostico_actual', models.CharField(blank=True, max_length=50)),
