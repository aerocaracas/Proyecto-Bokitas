...
class NutricionalForm(ModelForm):
    class Meta:
        ...
        labels = {'cedula_bef':'Cédula del Beneficiario','mercado_lorealiza':'Responsable de la compra en el mercado','frecuencia':'Frecuencia con que hace la compra','cocina_lorealiza':'Responsable de cocinar','apetito':'Cómo es su apetito?','cuantas_comidas':'Cuantas comidas realizan al día?','meriendas':'Cuantas meriendas?','cuantos_grupos':'Cuantos Grupos están presentes en su alimentación?','tipo_grupos':'Cuales son?','poco_vegetales':'El poco consumo o nada de Vegetales es:','poco_frutas':'El poco consumo o nada de Frutas es:','poco_viceras':'El poco consumo o nada de Viceras es:','bonos':'Recibe Bonos','bonos_entre':'Periodo de tiempo','clap':'Recibe el Clap','clap_entre':'Periodo de tiempo','iglesia':'Ayuda de la Iglesia','iglesia_entre':'Periodo de tiempo','familiar':'Ayuda Familiar','familiar_entre':'Periodo de tiempo','pensionado':'Cobra Pensión','pensionado_entre':'Periodo de tiempo','practica_deporte':'Practica algún Deporte?','medicamento':'Consume algún Madicamento o Suplemento Nutricional?','medicamento_suplemento':'Qué Medicamento o Suplemento consume?','agua':'Cómo es el consumo de Agua?','falla_servicio':'Cual Servicio presenta fallas?','conoce_grupos':'Conoce los 5 a 6 Grupos de Alimentos?','conoce_calidad':'Conoce cómo mejorar la calidad de la proteina vegetal?','conoce_desnutricion':'Conoce sobre la desnutrición y su consecuencia?'}
