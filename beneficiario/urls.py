...
urlpatterns = [
    ...
    path('beneficiario/<int:pk>/menor/<int:id>/medica/<int:idmed>/eliminar/', views.medica_eliminar, name='medica_eliminar'),
    ...
    path('beneficiario/<int:pk>/imc_benef/<int:idimc>/riesgo', views.imc_benef_riesgo, name='imc_benef_riesgo'),
