...
urlpatterns = [
    ...
    path('beneficiario/<int:pk>/actualizar/', views.proyecto_actualizar, name='proyecto_actualizar'),
    path('beneficiario/<int:pk>/jornada/', views.proyecto_jornada, name='proyecto_jornada'),
